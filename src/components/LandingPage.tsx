  ...
  return (
    <div className="w-full min-h-screen bg-white text-slate-900 flex flex-col font-sans">
      ...
      <section className="w-full bg-[#0A1838] text-white py-16 sm:py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 bg-[#1E293B] border border-slate-700 px-3.5 py-1.5 rounded-full">
              <span className="text-yellow-400 font-bold text-xs">#1 Platform for Indian Laundry Mats</span>
            </div>
      ...
      <section id="success-stories" className="w-full py-20 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">SUCCESS STORIES</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mt-1">
              Dhobis Earning 3x More with Us
            </h2>
          </div>
